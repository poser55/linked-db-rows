...
jbang JsonExport.java -p 2 -t blogpost  -db postgres  -u "jdbc:postgresql://localhost/demo" -l postgres -pw admin -fks 'user_table^^(id^^)^^-preferences^^(user_id^^)' --sqlScript "./src/test/resources/db/migration/V1.0.2__blog.sql" > blogpost2.json
